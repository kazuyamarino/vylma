			...
			<form action="@( base_url('crud/insert') )" method="POST" data-abide novalidate>
				...
				<div class="field">
					<label class="label">Username&nbsp;<small>(required)</small>
						<input class="input" type="text" name="username" id="username-help" placeholder="3 - 50 characters" pattern="^[a-z0-9\._-]{3,50}$" required>
				...
				<div class="field">
					<label class="label">Password&nbsp;<small>(required)</small>
						<input class="input" type="password" name="password" id="password-first" placeholder="5 - 16 characters" pattern="^[a-zA-Z0-9\.]{5,16}$" required>
						<span class="help is-error is-danger">
							<ul>
				...
				<div class="field">
					<label class="label">Confirm Password&nbsp;<small>(required)</small>
						<input class="input" type="password" placeholder="5 - 16 characters" pattern="^[a-zA-Z0-9\.]{5,16}$" data-equalto="password-first" required>
				...
				<div class="field">
					...
					<div id="radio-stat" class="radio-group">
						<div class="control">
							<label class="radio">
								<input type="radio" name="status" value="Y" id="act-stat" required>&nbsp;Yes
							</label>
							<label class="radio">
								<input type="radio" name="status" value="N" id="deact-stat">&nbsp;No
							</label>
						</div>
